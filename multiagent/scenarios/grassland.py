#Q. Long, Z. Zhou, A. Gupta, F. Fang, Y. Wu, X. Wang, Evolutionary population
#curriculum for scaling multi-agent reinforcement learning, in: International
...
class Scenario(BaseScenario):
    def __init__(self, n_good =5 , n_adv =2, n_landmarks = 4, n_food = 4, n_forests = 0, alpha = 0, sight = 0.5, no_wheel =False, ratio = 1.0, food_ratio=None):
        self.n_good = n_good
        self.n_adv = n_adv
